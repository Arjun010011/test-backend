...
class RecruiterCandidateController extends Controller
{
    public function index(CandidateIndexRequest $request, RecruiterService $recruiterService, CandidateStatusCatalog $statusCatalog): Response
    {
        ...
        $filters = [
            ...
            'has_resume' => $request->validated('has_resume'),
            'collection' => $request->validated('collection'),
            'sort' => $request->validated('sort', 'latest'),
            'per_page' => $request->validated('per_page', 10),
            'include_keywords' => $request->validated('include_keywords'),
            'exclude_keywords' => $request->validated('exclude_keywords'),
            'city' => $request->validated('city'),
            'experience_min' => $request->validated('experience_min'),
            'experience_max' => $request->validated('experience_max'),
            'industries' => $request->validated('industries'),
            'current_company' => $request->validated('current_company'),
            'previous_company' => $request->validated('previous_company'),
            'salary_min' => $request->validated('salary_min'),
            'salary_max' => $request->validated('salary_max'),
            'degree' => $request->validated('degree'),
            'major' => $request->validated('major'),
            'university' => $request->validated('university'),
            'gender' => $request->validated('gender'),
            'age_min' => $request->validated('age_min'),
            'age_max' => $request->validated('age_max'),
            'languages' => $request->validated('languages'),
            'english_fluency' => $request->validated('english_fluency'),
        ];
