    ...
    public function store(StoreCompanyRecruitmentRequest $request): RedirectResponse
    {
        ...
        try {
            Company::query()->create([
                ...
                'salary_min_lpa' => $request->validated('salary_min_lpa'),
                'salary_max_lpa' => $request->validated('salary_max_lpa'),
                'experience_min_years' => $request->validated('experience_min_years'),
                'experience_max_years' => $request->validated('experience_max_years'),
                'employment_type' => $request->validated('employment_type'),
                'work_mode' => $request->validated('work_mode'),
                'openings' => $request->validated('openings'),
                'skills_required' => $request->validated('skills_required'),
